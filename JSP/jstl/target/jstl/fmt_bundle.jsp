...
<body>
	...
	<fmt:bundle basename="resourceBundle.Res_Bun">
	...
	<fmt:bundle basename="resourceBundle.Res_Bun" prefix="count.">
		...
		<fmt:message key="k2">
			<fmt:param value="Mr.Dipak Prajapati"></fmt:param>
		</fmt:message><br/>
		<fmt:message key="k3">
			<fmt:param value="Mr.Shreyansh Soni"></fmt:param>
		</fmt:message><br/>
	...
	<fmt:setBundle basename="resourceBundle.Res_Bun" var="rs"
		scope="application" />
